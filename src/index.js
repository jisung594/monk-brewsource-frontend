...
// Shows Complete List of Beers (BEERS menu option in navbar) ------------------
  ...
  function showBeersByStyle(event) {
    ...
    fetch('https://monk-brewsource-api.herokuapp.com/api/v1/beers')
      .then(res => res.json())
      .then(beers => {
  ...
  function showBreweryByCountry(event) {
    ...
    fetch("https://monk-brewsource-api.herokuapp.com/api/v1/breweries")
      .then(res => res.json())
      .then(breweries => {
...
// Shows Detail Page of Specific Beer ------------------------------------------
  ...
  function showBeerDetailPage(event) {
    ...
    fetch(`https://monk-brewsource-api.herokuapp.com/api/v1/beers/${beerId}`)
      .then(res => res.json())
      .then(beer => {
        mainPage.innerHTML += `
    ...
    fetch('https://monk-brewsource-api.herokuapp.com/api/v1/reviews')
    .then(res => res.json())
  ...
  function showBreweryDetailPage(event) {
    ...
    fetch(`https://monk-brewsource-api.herokuapp.com/api/v1/breweries/${breweryId}`)
      .then(res => res.json())
      .then(brewery => {
